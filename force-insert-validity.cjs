...
const start = s.indexOf("function mapPermitPayload(permit, secureToken)");
const end = s.indexOf("async function ensureTokenForPermit", start);
...
console.log("FORCE INSERTED DYNAMIC VALIDITY ENGINE BEFORE ensureTokenForPermit");
